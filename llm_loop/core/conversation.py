...
class ConversationManager:
    ...
    def _should_exit(self, response_text: str, had_tool_calls: bool) -> bool:
        ...
        if not had_tool_calls:
            click.echo("LLM provided a textual response without requesting more tools.", err=True)
    ...
    def _log_iteration_start(self) -> None:
        ...
        max_turns_display = "unlimited" if self.config.max_turns == 0 else self.config.max_turns
        click.echo(
